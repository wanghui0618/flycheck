package com.dhcc.piccbid.entity.flycheckMedicalDetail;
 ...
 */
@Entity
@Table(name="T_FLYCHECK_MEDICAL_DETAIL")
public class FlycheckMedicalDetail implements Serializable {
