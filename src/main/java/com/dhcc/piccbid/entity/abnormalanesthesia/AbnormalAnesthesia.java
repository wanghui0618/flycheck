package com.dhcc.piccbid.entity.abnormalanesthesia;

import java.io.Serializable;

import javax.persistence.Column;

public class AbnormalAnesthesia implements Serializable{
	...
	public String toString() {
		return "AbnormalFrequencyTreatmentZY [hisid=" + hisid + ", zyh=" + zyh + ", admissionDate=" + admissionDate
				+ ", dischargeDate=" + dischargeDate + ", zyts=" + zyts + ", billDate=" + billDate
				+ ", dischargeDiseaseIdMain=" + dischargeDiseaseIdMain + ", dischargeDiseaseNameMain="
				+ dischargeDiseaseNameMain + ", totalAmount=" + totalAmount + ", bmiPayAmount=" + bmiPayAmount
				+ "]";
	}
