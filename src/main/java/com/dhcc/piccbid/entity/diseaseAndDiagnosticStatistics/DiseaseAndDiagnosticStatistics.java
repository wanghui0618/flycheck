package com.dhcc.piccbid.entity.diseaseAndDiagnosticStatistics;
...
/**
 * The persistent class for the T_FLY_MEDICAL_INHOS database table.
 * 
 */
@Entity
@Table(name="T_FLY_MEDICAL_INHOS")
public class DiseaseAndDiagnosticStatistics implements Serializable {
	private static final long serialVersionUID = 1L;

	@Column(name="ACCOMMODATION_FEE", length=100)
	...
	@Column(name="ADMISSION_DEPT_NAME", length=100)
	private String admissionDeptName;

	@Column(name="ADMISSION_DISEASE_ID", length=100)
	private String admissionDiseaseId;

	@Column(name="ADMISSION_DISEASE_NAME", length=100)
	private String admissionDiseaseName;

	@Column(name="BENEFIT_GROUP_ID", length=100)
	...
	@Column(name="BMI_AREA_ID", length=100)
	private String bmiAreaId;

	@Column(name="BMI_AREA_NAME", length=100)
	...
	@Column(name="BRIDGE_ID", length=100)
	private String bridgeId;

	@Column(precision=22)
	private BigDecimal cash;

	@Column(name="CHINESE_MEDICINE_FORM", length=100)
	private String chineseMedicineForm;

	@Column(name="CHINESE_MEDICINE_YINPIAN", length=100)
	private String chineseMedicineYinpian;

	@Column(name="CLAIM_TYPE", length=100)
	private String claimType;

	@Column(name="CONSULTATION_FEE", length=100)
	private String consultationFee;

	@Column(name="DAYS_RE_ADMISSION31", precision=22)
	...
	@Column(name="DIAGNOSIS_FEE", length=100)
	...
	@Column(name="DISCHARGE_DISEASE_ID_MAIN", length=100)
	...
	@Column(name="DISCHARGE_STATUS", length=100)
	...
	@Column(name="DRGS_CODE", length=100)
	private String drgsCode;

	@Column(name="DRGS_NAME", length=100)
	...
	@Column(name="IF_LOCAL_FLAG", length=100)
	private String ifLocalFlag;

	@Column(name="INSPECTION_FEE", length=100)
	private String inspectionFee;

	@Column(name="MATERIAL_FEE", length=100)
	private String materialFee;

	@Column(name="MEDICAL_RECORD_ID", length=100)
	...
	@Column(name="NB_TYPE", length=100)
	private String nbType;

	@Column(name="NURSING_FEE", length=100)
	private String nursingFee;

	@Column(name="OTHER_FEE", length=100)
	private String otherFee;

	@Column(name="P_LEVEL", length=100)
	...
	@Column(name="PATIENT_COMPANY", length=100)
	...
	@Column(name="SOCIAL_CARD_ID", length=100)
	private String socialCardId;

	@Column(name="TEST_FEE", length=100)
	private String testFee;

	@Column(name="TOTAL_AMOUNT", precision=22)
	private BigDecimal totalAmount;

	@Column(name="TRANSFER_DEPT_NAME", length=100)
	private String transferDeptName;

	@Column(name="TREATMENT_FEE", length=100)
	private String treatmentFee;

	@Column(name="WESTERN_MEDICINE_FEE", length=100)
	...
	public DiseaseAndDiagnosticStatistics() {
	}
