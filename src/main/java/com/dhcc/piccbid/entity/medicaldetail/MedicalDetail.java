...
public class MedicalDetail implements Serializable {
	...
	@Column(name="HIS_ITEM_CODE", length=50)
	private String hisItem_code;

	@Column(name="HIS_ITEM_NAME", length=50)
	...
	public String getHisItem_code() {
		return hisItem_code;
	}

	public void setHisItem_code(String hisItem_code) {
		this.hisItem_code = hisItem_code;
	}
	...
	public String toString() {
		return "MedicalDetail [id=" + id + ", adviceGroup=" + adviceGroup + ", adviceId=" + adviceId + ", adviceOrder="
				+ adviceOrder + ", applyPayAmount=" + applyPayAmount + ", applyPayLevel=" + applyPayLevel
				+ ", balanceDate=" + balanceDate + ", billingNo=" + billingNo + ", chargeType=" + chargeType
				+ ", cityCode=" + cityCode + ", createDate=" + createDate + ", deliverWay=" + deliverWay
