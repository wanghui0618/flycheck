 ...
 * 
 */
public class DocumentSearchVo implements Serializable {
	...
	public String toString() {
		return "DocumentSearchVo [id=" + id + ", deductions=" + deductions + ", typeName=" + typeName + ", typeNo="
				+ typeNo + ", returnCode=" + returnCode + ", returnName=" + returnName + ", returnDesc=" + returnDesc
				+ ", withholdingAmount=" + withholdingAmount + ", appealResult=" + appealResult
				+ ", withholdingQuantity=" + withholdingQuantity + ", adviceGroup=" + adviceGroup + ", adviceId="
				+ adviceId + ", adviceOrder=" + adviceOrder + ", applyPayAmount=" + applyPayAmount + ", applyPayLevel="
				+ applyPayLevel + ", balanceDate=" + balanceDate + ", billingNo=" + billingNo + ", chargeType="
				+ chargeType + ", cityCode=" + cityCode + ", createDate=" + createDate + ", deliverWay=" + deliverWay
				+ ", departCode=" + departCode + ", departName=" + departName + ", docCode=" + docCode + ", docName="
				+ docName + ", dosageDays=" + dosageDays + ", doseForm=" + doseForm + ", doseUnit=" + doseUnit
				+ ", drugMeaUnit=" + drugMeaUnit + ", drugType=" + drugType + ", durgDosage=" + durgDosage
				+ ", feeCreateDate=" + feeCreateDate + ", feeMeaUnit=" + feeMeaUnit + ", fullOrdination="
				+ fullOrdination + ", fullPayment=" + fullPayment + ", fundCost=" + fundCost + ", handdingInsCode="
				+ handdingInsCode + ", hosServiceName=" + hosServiceName + ", ilegalType=" + ilegalType + ", insCost="
				+ insCost + ", isIlegal=" + isIlegal + ", isInsuranceProject=" + isInsuranceProject + ", itemCode="
				+ itemCode + ", itemCost=" + itemCost + ", itemName=" + itemName + ", itemNum=" + itemNum
				+ ", itemPrice=" + itemPrice + ", itemStandard=" + itemStandard + ", itemUnit=" + itemUnit
				+ ", limitPrice=" + limitPrice + ", medicalCloseNumber=" + medicalCloseNumber + ", medicalId="
				+ medicalId + ", medicalInsCode=" + medicalInsCode + ", medicalInsName=" + medicalInsName
				+ ", notInsCost=" + notInsCost + ", partialOrdination=" + partialOrdination + ", partialPayment="
				+ partialPayment + ", prescriptionDischarge=" + prescriptionDischarge + ", projectType=" + projectType
				+ ", recipelId=" + recipelId + ", seeDocCode=" + seeDocCode + ", selfPayAmount=" + selfPayAmount
				+ ", selfPayRate=" + selfPayRate + ", singleDose=" + singleDose + ", specs=" + specs + ", sumAmount="
				+ sumAmount + ", takeFrequence=" + takeFrequence + ", totalDrugIntake=" + totalDrugIntake
				+ ", updateDate=" + updateDate + ", useDay=" + useDay + "]";
	}
