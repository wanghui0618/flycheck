package com.dhcc.piccbid.web.rest.sametimeHospital;
...
import com.dhcc.piccbid.blh.sametimeHospital.SametimeHospitalBlh;
import com.dhcc.piccbid.dto.sametimeHospital.SametimeHospitalDto;
import com.dhcc.piccbid.entity.page.Page;


@RestController
@RequestMapping("/dhccApi/sametimeHospitalrest")
public class SametimeHospitalRest {
	
	@Resource
	private  SametimeHospitalBlh blh;
	
	
	@RequestMapping(value="/getSametimeHospital")
    public Page getSametimeHospital(SametimeHospitalDto dto) {
    	blh.getSametimeHospital(dto);
        Page page = new Page();
	...
	@RequestMapping(value="/getSametimeHospitalbyhisidTable")
    public Page getSametimeHospitalbyhisidTable(SametimeHospitalDto dto) {
    	blh.getSametimeHospitalbyhisidTable(dto);
        Page page = new Page();
        page.setData(dto.getPageModel().getPageData());
        page.setCount(String.valueOf(dto.getPageModel().getTotals()));
        return page;
    ...
    public SametimeHospitalDto expDate(SametimeHospitalDto dto) {
        blh.exportD(dto);
        return dto;
    }
    //下载
