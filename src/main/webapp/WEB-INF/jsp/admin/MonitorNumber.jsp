...
<div class="layui-fluid">
  <div class="layui-card">
          <div class="layui-card-header" style="border-bottom: 1px solid #f6f6f6;">
		   ...
		   <table id="MonitorNumber" class="layui-hide" lay-filter="MonitorNumber"></table>
     </div>
    </div>
		...
		layui.config({
			    ...
			    table.render({
			    	elem: '#MonitorNumber'
			    		/* ,url: $WEB_ROOT_PATH+"/dhccApi/admin/admin/MonitorNumber" */
			    		,url: $WEB_ROOT_PATH+"/dhccApi/admin/admin/MonitorNumber"
			        ,cellMinWidth: 80
			        ,height: document.documentElement.clientHeight-65
			        ,cols: [[
			         {type: 'numbers', width:120, title: '排名'}
					,{field:'pname', align:'center',title: '规则名称' }
