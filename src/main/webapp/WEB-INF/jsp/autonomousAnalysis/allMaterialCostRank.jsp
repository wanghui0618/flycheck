...
<div class="layui-fluid">
      ...
      <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
                ...
                <div class="layui-input-inline"style="" >
                    <input type="text" name="inFlag" style=""  class="layui-input" id="test6" placeholder="yyyy" readonly="true">
                </div>
            		</div>
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/autonomousAnalysis/allMaterialCostRank.js"></script>
