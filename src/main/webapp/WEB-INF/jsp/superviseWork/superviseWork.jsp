...
<div class="layui-fluid">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline" id="selProvince">
				...
				<div class="layui-input-block">
					<input type="text" style="width:150px;" name="diseasesFirst.id" placeholder="请输入" autocomplete="off" class="layui-input">
				</div>
			</div>
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/superviseWork/superviseWork.js"></script>
</body>
</html>