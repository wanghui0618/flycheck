	...
	<div class="layui-fluid">
		<div class="layui-card">
				...
				<div class="layui-form-item">
					...
					<div class="layui-inline pt">
						...
						<div class="layui-input-block">
							<input type="text"
								name="drugInteraction.drugName" placeholder="请输入药品名称" autocomplete="off"
								class="layui-input">
						</div>
					</div>
					...
					<!-- <div class="layui-inline" style="margin-left:15px">
						<button id='add' data-type="add"
							...
							lay-filter="LAY-user-front-add">添加</button>
					</div> -->
				</div>
			</div>
			...
			<div class="layui-card-body" style="padding-left: 0px;">
    			...
    			<div class="layui-card" style="margin-left:0;width:550px;margin: 3px 0px 0px 0px;" >
					<table id="drugTable" class="layui-hide" lay-filter="drugTable"></table>
				</div>
				</div>
				
				<div class="layui-col-md7" >
    			<div class="layui-card" style="width:853px;margin-left:1px;margin: 3px 0px 0px 0px;" >
				...
				<div class="layui-col-md5" >
    			<div class="layui-card" style="margin-left:0;margin: 3px 0px 0px 0px;" >
...
        			 {{# } }}
          			 {{#if (!existsButton('drugInteraction-interaction-add')) { }}
         					<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="add"><i class="layui-icon layui-icon-edit"></i>添加药物作用</a> 
        			 {{# } }}
...
        			 {{# } }}
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/app/js/drugInteraction/drugInteraction.js"></script>
</body>
</html>