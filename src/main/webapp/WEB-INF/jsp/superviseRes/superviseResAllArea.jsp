...
<body>
	<div class="layui-fluid">
		<div class="layui-card">
			...
			<div class="layui-card-header" style="border-bottom: 1px solid #f6f6f6;">
  					...
  					统筹区违规人次全部信息<select id="findYearBoss" name="year"
	...
	function getValueBoss(){
		...
		if(value=="终审"){
			mpath =$WEB_ROOT_PATH+'/dhccApi/superviseRes/superviseRes/getAllAreaData1';
			layui.table.reload('violationDetail',{
				 url: mpath
		     });
			
		}else if(value=="机审"){
			mpath =$WEB_ROOT_PATH+'/dhccApi/superviseRes/superviseRes/getAllAreaData1JS';
			layui.table.reload('violationDetail',{
				 url: mpath
		     });
			layui.table.reload('violationDetail',{
	...
	layui.config({
		...
		table.render({
			...
			,url: $WEB_ROOT_PATH+"/dhccApi/superviseRes/superviseRes/getAllAreaData1JS"
			 ,height: document.documentElement.clientHeight-65
			,cellMinWidth: 80
		    ,cols: [[
			 {type: 'numbers', title: '序号' }
			,{field:'pname',title: '统筹区',align:"center"}
			,{field:'pnumber',title: '违规人次',align:"center",templet:function(d){
     		   var codex = d.pnumber;
    		   if(codex == null){
    			   codex="-";
    		   }else{
