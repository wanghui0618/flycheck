...
/* 			    
	...
	/* 			
		       ...
		       /*  $.getJSON($WEB_ROOT_PATH+'/dhccApi/admin/admin/findOrgNameDict',
			    ...
			    table.render({
			    	elem: '#todayTable'
			        ,url: $WEB_ROOT_PATH+'/dhccApi/admin/admin/IntegrityToday'
			     /*    ,where: {inFlag: str}  */
			        ,cellMinWidth: 80
			        ,height:document.documentElement.clientHeight-80
			        ,cols: [[
			        	{type: 'numbers',width:80,align:'center',title: '序号 '}
			        /*   ,{field:'cityName',width:160,align:'center', title: '城市名称' } */
					  ,{field:'orgName',width:320,align:'center', title: '医院名称' }
					  ,{field:'totalNumber',align:'center', title: '数据总量' }
					  ,{field:'effectNumber',align:'center', title: '完整数据' }
					  ,{field:'uneffectNumber',align:'center', title: '不完整数据数据' }
					  ,{field:'effective',align:'center', sort:true,title: '完整率' ,templet: function(d){
							var codex = d.effective;
							if(codex==0){
