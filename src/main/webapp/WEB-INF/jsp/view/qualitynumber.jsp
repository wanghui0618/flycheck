		...
		/* 	    var time=(new Date).getTime()-24*60*60*1000;
		 ...
		 /*        //加载医疗机构下拉字典
		       ...
		       /*  $.getJSON($WEB_ROOT_PATH+'/dhccApi/admin/admin/findOrgNameDict',
			    ...
			    table.render({
			    	elem: '#todayTable'
			        ,url: $WEB_ROOT_PATH+'/dhccApi/admin/admin/QualityToday'
			       /*  ,where: {inFlag: str}  */
			        ,cellMinWidth: 80
			        ...
			        ,cols: [[
			         ...
			         /*  ,{field:'cityName',width:160,align:'center', title: '城市名称' } */
					  ...
					  ,{field:'effectNumber',align:'center', title: '有效数据' }
					  ,{field:'uneffectNumber',align:'center', title: '无效数据' }
					  ,{field:'effective',align:'center',sort:true, title: '有效率' ,templet: function(d){
