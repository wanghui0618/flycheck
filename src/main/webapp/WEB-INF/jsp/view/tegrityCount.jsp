...
<table id="tegrityTable" class="layui-hide" lay-filter="deleteTable"></table>
      </div>
    </div>
	<script type="text/javascript" src="<%=request.getContextPath()%>/app/js/view/tegrityCount.js"></script>
