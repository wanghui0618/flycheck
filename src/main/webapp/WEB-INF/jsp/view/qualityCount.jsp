...
<table id="qualityTable" class="layui-hide" lay-filter="deleteTable"></table>
      </div>
    </div>
	<script type="text/javascript" src="<%=request.getContextPath()%>/app/js/view/qualityCount.js"></script>
