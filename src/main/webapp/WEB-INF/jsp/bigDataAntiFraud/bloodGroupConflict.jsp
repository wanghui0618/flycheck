...
<div class="layui-fluid">
        		...
        		<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" id="startTime" name="countDataVo.startTime"
								lay-verify="required" placeholder="请输入患者姓名" autocomplete="off"
								class="layui-input">
						</div>
					</div>
			<div class="layui-inline">
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/resultAppeal/overtreatment4.js"></script>
</body>
</html>