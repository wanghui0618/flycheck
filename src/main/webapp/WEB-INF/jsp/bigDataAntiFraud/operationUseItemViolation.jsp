            ...
            <div class="layui-tab layui-tab-card">
                <div class="layui-tab-content" >
                    <div class="layui-tab-item layui-show" >
                        <a style="width:23%;font-size:1rem;display:inline-block;" >问题类型：手术</a>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/bigDataAntiFraud/operationUseItemViolation.js"></script>
</body>
</html>