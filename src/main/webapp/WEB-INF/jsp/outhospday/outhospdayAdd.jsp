    ...
    <fieldset style="width:90%;">
        <div class="layui-card-body">
            <div class="layui-form" lay-filter="layuiadmin-form-useradmin"
                ...
                <input type="hidden" name="outhospday.id" id="id" hide=true>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="cityCode"
                                   name="outhospday.cityCode" autocomplete="off" lay-verify="cityCode"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="typeNo"
                                   name="outhospday.typeNo" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="typeName"
                                   name="outhospday.typeName" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="itemCode"
                                   name="outhospday.itemCode" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="itemName"
                                   name="outhospday.itemName" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="logicType"
                                   name="outhospday.logicType" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="logicTypeDetail"
                                   name="outhospday.logicTypeDetail" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="logic"
                                   name="outhospday.logic" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="logicSql"
                                   name="outhospday.logicSql1" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" id="comments"
                                   name="outhospday.comments" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                </div>
