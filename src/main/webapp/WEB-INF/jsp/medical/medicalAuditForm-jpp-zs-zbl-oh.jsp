...
<div class="layui-form" id="layuiadmin-form-useradmin" lay-filter="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
    ...
    <input type="hidden" name="medicalAudit.fileurl" id="fileurl" hide=true>
        ...
        <div class="layui-input-inline">
            <input type="text" id="reviewResult" name="medicalAudit.reviewResult" placeholder="" readonly="readonly"
                   autocomplete="off"
                   class="layui-input">
        </div>
        <label class="layui-form-label">巡查记录状态</label>
        <div class="layui-input-inline">
            <input type="text" id="patrolRecordState" name="medicalAudit.patrolRecordState" placeholder="" readonly="readonly"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-inline">
            <input type="text" id="patrolTime" name="medicalAudit.patrolTime" placeholder="" readonly="readonly"
                   autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
       <label class="layui-form-label">总金额</label>
        <div class="layui-input-inline" style="width: 180px;">
        	<input type="text" id="totalAmount" name="totalAmount" lay-verify="" placeholder="" autocomplete="off" class="layui-input" readonly="readonly">
     	 </div>
    </div>
    <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">审核意见</label>
        <div class="layui-input-block">
                    <textarea style="width: 600px;height: 80px;" id="auditOpinion" lay-verify="article_desc" name="medicalAudit.auditOpinion" cols="20"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-inline">
        <textarea style="width: 600px;height: 80px;" id="overallProblem" lay-verify="article_desc" name="medicalAudit.overallProblem" cols="20"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
             <textarea style="width: 600px;height: 80px;" id="patrolConclusion" lay-verify="article_desc" name="medicalAudit.patrolConclusion"
...
function child(obj){
	  ...
	  console.log(result);
	  var medical=result.medicalAuditOnline;
	  console.log(medical);
