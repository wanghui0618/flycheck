...
<div class="layui-form" id="layuiadmin-form-useradmin" lay-filter="layuiadmin-form-useradmin" style="padding: 20px 0 0 0;">
      <div class="layui-form-item"  >
    									...
    									<div class="layui-input-block">
      										<input type="radio" id="medicalAudit.aduitStatus" name="medicalAudit.aduitStatus" value="2" title="正常" checked class="layui-form-item" >
      										<input type="radio" id="medicalAudit.aduitStatus"  name="medicalAudit.aduitStatus" value="0" title="违规"  class="layui-form-item" >
   										 </div>
  									 </div> 
