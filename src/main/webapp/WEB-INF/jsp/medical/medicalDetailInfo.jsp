...
<div class="layui-fluid">
    <div class="layui-card">
      ...
      <div class="layui-form-item">
       ...
       <div class="layui-inline">
            ...
            <button class="layui-btn layuiadmin-btn-useradmin" data-type=addinfo><i class="layui-icon layui-icon-add-circle layuiadmin-button-btn"></i>添加</button>
          </div>
          
        <div class="layui-card-body">
        <table id="medicalTable" class="layui-hide" lay-filter="medicalTable"></table>
         <script type="text/html" id="table-useradmin-webuser">
          <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="editinfo">编辑</a>
          <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delinfo">删除</a>
        </script>
      </div>
 ...
 var medicalDetail1;
  //"billingNo1":medicalDetail.billingNO;
 // "tPiccbidMedicalId1":medicalDetail.id;
  function child(obj){
	  var medicalDetail = JSON.parse(obj);
	  medicalDetail1={medicalId:medicalDetail.id, billingNo:medicalDetail.billingNo};
