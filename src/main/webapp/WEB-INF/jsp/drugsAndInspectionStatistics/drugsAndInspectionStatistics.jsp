...
<%--                </div>--%>
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="drugsAndInspectionStatistics.itemNameIns" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>
               <%-- <div class="layui-inline" style="width: 310px;">
                    <label class="layui-form-label" style="width: 100px;">检查项目名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="drugsAndInspectionStatistics.itemNameHos" placeholder="请输入" autocomplete="off" class="layui-input">
                    </div>
                </div>--%>
      ...
      <div class="layui-card-body">
            ...
            <script type="text/html" id="table-useradmin-webuser">
                <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="costDetail"><i class="layui-icon "></i>费用明细</a>
                <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="personInfo"><i class="layui-icon"></i>参保人员信息</a>
            </script>
        </div>
    </div>
</div>
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/drugsAndInspectionStatistics/drugsAndInspectionStatistics.js"></script>
</body>
</html>