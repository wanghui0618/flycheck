...
<div class="layui-fluid">
        ...
        <div class="layui-form-item">
          <!-- <div class="layui-inline">
            ...
            <div class="layui-input-block">
              <input type="text" style="width:100px;" name="fertility.itemCode" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div> -->
          <div class="layui-inline">
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/cy_check/fertility.js"></script>
</body>
</html>