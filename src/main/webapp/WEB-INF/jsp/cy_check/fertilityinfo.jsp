...
<div class="layui-fluid">
      ...
      <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
            ...
            <div class="layui-input-block">
              <input type="text" style="width:100px;" name="fertility.billingNo" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div> -->
          <div class="layui-inline">
            <label class="layui-form-label">是否违规</label>
            <div class="layui-input-block" style="width:100px;">
              <select name="fertility.ilegalFertility">
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/cy_check/fertilityinfo.js"></script>
  <script>
