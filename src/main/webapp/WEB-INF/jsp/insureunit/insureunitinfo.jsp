		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="unitId"
					name="insureUnit.unitId" lay-verify="required"
					placeholder="请输入单位编号 " autocomplete="off" class="layui-input">
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="stateOrgCode"
					...
					placeholder="请输入组织机构代码 " autocomplete="off" class="layui-input">
			</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="unitNature"
					...
					placeholder="请输入单位性质" autocomplete="off" class="layui-input">
			</div>
			...
			<div class="layui-input-inline">
				<input type="text" id="unitInsurance"
					...
					placeholder="请输入投保的险种 " autocomplete="off" class="layui-input">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="unitInsranceName"
					...
					placeholder="请输入单位目前投保的险种名称" autocomplete="off" class="layui-input">
			</div>
		</div>
