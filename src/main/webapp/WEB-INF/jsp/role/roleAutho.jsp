...
<div class="layui-tab layui-tab-brief" lay-filter="demo" >
    ...
    <div class="layui-tab-content">
        <div  id="nodes" class="layui-tab-item layui-show">
            <div id ="beforeMenus" class="layui-card" style="min-height:493px">
        ...
        <div  id="datas" class="layui-tab-item" style="overflow: hidden;">
            <div id ="beforeDatas" class="layui-card" style="min-height:493px">
                <div class="layui-card-body" style="padding-left: 0px;padding-right: 0px;">
                    <div class="layui-form-item" >
                        <div class="layui-inline">
        ...
        <div  id="button" class="layui-tab-item" style="overflow: hidden;">
            <div id="beforeButton" class="layui-card" style="min-height:493px">
                <div class="layui-card-body" style="padding-left: 0px;padding-right: 0px;">
                    <div class="layui-form-item" >
                        <div class="layui-inline">
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/role/roleAutho.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/role/roleAutho-data.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/role/roleAutho-button.js"></script>
</body>
</html>