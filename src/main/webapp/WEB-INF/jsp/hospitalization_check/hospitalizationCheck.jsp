...
<div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-form-item">
          <!-- <div class="layui-inline">
            ...
            <div class="layui-input-block">
              <input type="text" style="width:100px;" name="costdetail.itemCode" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div> -->
          <div class="layui-inline">
            <label class="layui-form-label">收费单据号</label>
            <div class="layui-input-block">
              <input type="text" style="width:100px;" name="costdetailHos.billingNo" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-inline">
            <label class="layui-form-label">是否违规</label>
            <div class="layui-input-block" style="width:100px;">
              <select name="costdetailHos.ilegalHospitalization">
          ...
          <div class="layui-inline">
            <label class="layui-form-label">case_no</label>
            <div class="layui-input-block">
              <input type="text" style="width:100px;" name="costdetailHos.caseNo" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-inline">
      ...
      <div class="layui-card-body">
     	<font color="red">限住院违规判断：0-未违规，1-违规</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/hospitalizationCheck/hospitalizationCheck.js"></script>
