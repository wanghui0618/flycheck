...
<div class="layui-fluid">
    <div class="layui-card">
      ...
      <div class="layui-card-body">
     	...
     	<font color="blue">查询条件：项目编码-item_code唯一确定一条诊疗明细记录，收费单据号-billing_no唯一确定一个人</font>
        <table id="hsTable" class="layui-hide" lay-filter="hsTable"></table>
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/hospitalizationCheck/hospitalizationCheckInfo.js"></script>
  <script>
