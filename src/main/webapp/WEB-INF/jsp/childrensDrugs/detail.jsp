        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-block">
                        <input type="text" style="width: 140px;"
                               name="ChildrensDrugsVo.itemName" placeholder="查询医保项目名称"
                ...
                <div class="layui-inline ">
                    ...
                    <div class="layui-input-block">
                        <input type="text" style="width: 140px;"
                               name="ChildrensDrugsVo.itemId" placeholder="查询医保项目编码"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input id="fyType" name="ChildrensDrugsVo.pCategory" />
                    </div>
                </div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/app/js/childrensDrugs/detail.js"></script>
