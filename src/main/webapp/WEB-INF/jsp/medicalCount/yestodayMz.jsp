...
<!-- 				            <button class="layui-btn layuiadmin-btn-useradmin" data-type="add">添加</button>
          ...
          <div class="layui-card-body" style="padding-top:0px">
			     <table id="yestodayMzTable" class="layui-hide" lay-filter="yestodayMzTable"></table>
			   </div>
        </div>
      </div>
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/medicalCount/yestodayMz.js"></script>
