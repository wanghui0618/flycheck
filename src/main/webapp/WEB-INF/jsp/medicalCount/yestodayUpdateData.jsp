...
<!-- 				            <button class="layui-btn layuiadmin-btn-useradmin" data-type="add">添加</button>
          ...
          <div class="layui-card-body" style="padding-top:0px">
			     <table id="yestodayUpdateTable" class="layui-hide" lay-filter="yestodayUpdateTable"></table>
			   </div>
        </div>
      </div>
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/medicalCount/yestodayUpdateData.js"></script>
