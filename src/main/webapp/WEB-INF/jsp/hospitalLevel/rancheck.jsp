    ...
    <div class="layui-card">
        ...
        <div class="layui-form-item">
          <div class="layui-inline">
            ...
            <div class="layui-input-block">
              <input type="text" id="billingNo" style="width:100px;" name="orgVO.billingNo" placeholder="请输入" autocomplete="off" class="layui-input">
            </div>
          </div>
          <div class="layui-inline">
            <label class="layui-form-label">是否违规</label>
            <div class="layui-input-block" style="width:100px;">
              <select name="orgVO.ilegalOrgLevel">
      ...
      <div class="layui-card-body">
        ...
        <script type="text/html" id="table-useradmin-webuser">
          ...
          <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="changeToWeigui"><i class="layui-icon layui-icon-edit"></i>标为违规</a>
		  <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="viewInfo">明细</a>
        </script>
      </div>
    </div>
  </div>
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/hospitalLevel/rancheck.js"></script>
</body>
</html>