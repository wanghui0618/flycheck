...
<div class="layui-fluid">
    <div class="layui-card">
      <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
          ...
          <font color="red">限医院等级用药违规判断：0-未违规，1-明确违规，2-疑似违规</font>
        </div>
      </div>
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/hospitalLevel/orgCheckInfo.js"></script>
  <script>
  var org_code,billing_no,admission_no;
  function child(obj){
