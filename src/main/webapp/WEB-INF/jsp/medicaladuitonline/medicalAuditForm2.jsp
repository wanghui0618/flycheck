   ...
   <div class="layui-form-item layui-form-text">
    <input type="hidden" name="medicalAudit.fileurl" id="fileurl" hide=true>
        ...
        <div class="layui-input-inline">
            <input type="text" id="reviewResult" name="medicalAuditOnline.reviewResult" placeholder=""
                   autocomplete="off"
                   class="layui-input">
        </div>
        <label class="layui-form-label">巡查记录状态</label>
        <div class="layui-input-inline">
            <input type="text" id="patrolRecordState" name="medicalAuditOnline.patrolRecordState" placeholder=""
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-inline">
            <input type="text" id="patrolTime" name="medicalAuditOnline.patrolTime" placeholder=""
                   autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item layui-form-text">
      ...
      <div class="layui-form-item"  >
    									...
    									<div class="layui-input-block" id="aduitStatus">
      										<input type="radio"   name="medicalAuditOnline.aduitStatus" lay-filter="status1" value="0" title="违规"  checked="false" class="layui-form-item" >
      										<input type="radio"   name="medicalAuditOnline.aduitStatus" lay-filter="status2" value="2" title="正常"    class="layui-form-item" >
   										 </div>
  									 </div> 
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/medicalauditonline/medicalAuditForm.js"></script>
