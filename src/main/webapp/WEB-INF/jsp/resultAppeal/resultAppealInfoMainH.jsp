			...
			<div class="layui-card-body">
				<div class="layui-form" lay-filter="layuiadmin-form-useradmin"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" id="totalAmount" lay-filter="number"	 readonly="true" name="totalAmount" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">扣除原因</label>
						<div class="layui-input-inline">
							<input type="text" id="userVerifyRemarks"	readonly="true" name="userVerifyRemarks" autocomplete="off" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">审核意见</label>
							<div class="layui-input-inline">
							<textarea style="width: 600px" placeholder="审核意见（待处理）" readonly="true"
					...
					<!-- 第6行 -->
						...
						<legend>医院提交附件</legend>
					</fieldset>
					<div class="layui-form-item">
						<div class="layui-inline " style="margin-left: 108px">
							<div class="btns" style="width: 300px; height:50px;">
								<div id="filepicker" style="width: 100px;">选择附件</div>
							</div>
	  ...
	  if(money==null||money=="null"){
		...
		if (appealDate == null || appealDate == '') {
				...
				if (status != '5') {
					...
					$(document).find('.delFile').css({"display":"none"}); 
					$("#delImg").css("display","none");
					$(document).find('#delImg').css("display","none"); 
				 	$(document).find('.layui-layer-btn .layui-layer-btn0').css({"display":"none"});
					$(document).find('#WU_FILE_0 > div:nth-child(1)').css("display","none");
				}
			});
