...
<body>
			...
			<div class="layui-card-body">
				<div class="layui-form" lay-filter="layuiadmin-form-useradmin"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" id="totalAmount"	name="totalAmount" autocomplete="off" class="layui-input" readonly="readonly">
						</div>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label">扣除原因:</label>
						<div class="layui-input-inline">
							<input type="text" id="userVerifyRemarks"	name="userVerifyRemarks" autocomplete="off" class="layui-input" readonly="readonly">
						</div>
					</div>
					<!-- 第4行 -->
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" id="examinePerson"
								name="resultAppealVo.examinePerson" placeholder="请输入审核人"
								autocomplete="off" class="layui-input" readonly="readonly">
						</div>
					</div>
					<!-- 第5行 -->
 ...
 <script>
  ...
  var fileurl;
  var fileResurl;
  function child(medical_id){
	  //alert(id);
		var url=$WEB_ROOT_PATH+'/dhccApi/medical/medical/findResultAppealMain';
		var filed={"resultAppeal.medicalId":medical_id};
		$.post(url,filed,function(data){
		      ...
		      $("#userVerifyRemarks").val(data.userVerifyRemarks);
		      console.log(fileurl);
		      console.log(fileResurl);
