...
<body>
									...
									<div
										...
										<div class="layui-form-item" style="height: 35px">			
													...
													<div class="layui-inline" style="margin-top: 1px;">
														<button id="resultAppeal-examineAll" class="layui-btn layuiadmin-btn-useradmin layui-btn-sm"
															lay-submit lay-filter="LAY-user-front-search-allUpdate" style="display: none"  stylename="allUpdate">
															<i class="layui-icon layui-icon-auz layuiadmin-button-btn"></i>批量提交
														</button>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/resultAppeal/resultAppeal.js"></script>
</body>
</html>