...
<body>
	...
	<!-- 				<div class="layui-inline">
				...
				<div id="shangla" onclick="hideSearch()" style="color:#2284FF;cursor:pointer; margin-left: 10px;z-index:9999;display: inline-block;">收起<img style="margin: 0 auto;height: 6px;width: 8px;" src="<%=request.getContextPath()%>/images/main/shangla.png" /></div>
								...
								<div class="layui-card">
									...
									<div
										...
										<div class="layui-form-item">			
													...
													<div class="layui-inline">
														<button id="resultAppealH-examineAll" class="layui-btn layuiadmin-btn-useradmin layui-btn-sm"
															lay-submit lay-filter="LAY-user-front-search-allUpdate"  stylename="allUpdate">
															<i class="layui-icon layui-icon-auz layuiadmin-button-btn" style="font-size:12px"></i>批量提交
														</button>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/resultAppeal/resultAppealH.js"></script>
</body>
</html>