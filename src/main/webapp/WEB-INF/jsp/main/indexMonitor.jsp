...
<div style="display: none;" id="tz-hide"  href="javascript:;" lay-href="<%=request.getContextPath()%>/medical/medicaltab-jpp-zs"></div>
			...
			<div class="layui-header"
				...
				<ul class="my-head-left">
					...
					<li style="margin-left: 5px; font-size: 15px; color: #fff"
						class="layui-nav-item">规则统计分析<span id="textHidden">&nbsp;>&nbsp;主页</span></li>
				</ul>
	...
	function tz(){
		...
		var Request = GetRequest();
		 ...
		 var tcqCode=Request["tcqCode"];
		 tcqCode=decodeURI(tcqCode);
		 tcqCode=encodeURI(encodeURI(tcqCode));
		 var bzCode=Request["bzCode"];
		 bzCode=decodeURI(bzCode);
		 bzCode=encodeURI(encodeURI(bzCode));
		 //获取url.模拟点击
		 if(type=='1'){
			var cs="/piccbid/indicator/costAnalysis-zy";
		 	var urlGo=cs;
		 	$("#tz-hide").attr('lay-href',urlGo);
		 	$("#tz-hide").html("住院次均费用分析");
		 	$('#tz-hide').trigger("click");
		 }else if(type=='2'){
			 var cs="/piccbid/indicator/diseasesAnalysisTest?bzCode="+bzCode;
			 var urlGo=cs;
			 $("#tz-hide").attr('lay-href',urlGo);
			 $("#tz-hide").html("病种分析");
			 $('#tz-hide').trigger("click"); 
		 }else if(type=='3'){
			 var cs="/piccbid/itemCost/medicalCost";
			 var urlGo=cs;
			 $("#tz-hide").attr('lay-href',urlGo);
			 $("#tz-hide").html("药品金额统计");
			 $('#tz-hide').trigger("click"); 
		 }else if(type=='4'){
			 var cs="/piccbid/indicator/drugAnalysis";
			 var urlGo=cs;
			 $("#tz-hide").attr('lay-href',urlGo);
			 $("#tz-hide").html("药占比分析");
			 $('#tz-hide').trigger("click"); 
		 }else if(type=='5'){
			 var cs="/piccbid/analysisOfPersonTime/analysisOfPersonTime?tcqCode="+tcqCode;
			 var urlGo=cs;
			 //console.log("11111");
			 $("#tz-hide").attr('lay-href',urlGo);
			 $("#tz-hide").html("就诊人次分析");
			 ...
			 var cs="/piccbid/indicator/hospitalizationAnalysis";
			 var urlGo=cs;
			 $("#tz-hide").attr('lay-href',urlGo);
			 $("#tz-hide").html("住院天数分析");
			 $('#tz-hide').trigger("click"); 
