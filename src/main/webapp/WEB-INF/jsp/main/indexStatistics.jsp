...
<body class="layui-layout-body">
			...
			<div class="layui-header"
				...
				<ul class="my-head-left">
					...
					<li style="margin-left: 5px; font-size: 15px; color: #fff"
						class="layui-nav-item">统计分析<span id="textHidden">&nbsp;>&nbsp;主页</span></li>
				</ul>
				<ul class="layui-nav layui-layout-right"
					lay-filter="layadmin-layout-right">
					<li class="layui-nav-item layui-hide-xs">
						<a href="javascript:;" style="margin: 0; padding: 0;">
							<button type="button" onclick="gosaiku()" id="gosaiku" class="btn btn-success btn-lg btn-block">自主分析</button>
						</a>
					</li>
	...
	<script>
		...
		function gosaiku(){
			var url=$WEB_ROOT_PATH+"/dhccApi/saikuwindow/saikuWindow/findIp";
			$.post(url,function(data1){
				 window.open(data1);
			});
			/* var url=$WEB_ROOT_PATH+"/dhccApi/saikuwindow/saikuWindow/list";
		    $.post(url,function(data){
				
			}); */
			//跳转到saiku界面
			/* window.open("http://localhost:8080/saiku/index.html?saiku=dGVrZXQ9YWRtaW4="); */
		}
