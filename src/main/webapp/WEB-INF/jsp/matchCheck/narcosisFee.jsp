				...
				<div class="layui-form-item">
					<div class="layui-inline ">
						...
						<div class="layui-input-inline">
							<select name="narcosisFee.cityCode" id="city" lay-search="">
					...
					<div class="layui-inline">
						...
						<div class="layui-input-inline">
							<input type="text" name="narcosisFee.itemCode" placeholder="请输入"
					...
					<div class="layui-inline">
						<label class="layui-form-label" style="width: 90px;">目录名称</label>
						<div class="layui-input-inline">
							<input type="text" name="narcosisFee.itemName" placeholder="请输入"
								autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					<div class="layui-inline">
						...
						<button id="drugRule-add"
							class="layui-btn layuiadmin-btn-useradmin" stylename="add"
							data-type="add">
...
<script type="text/html" id="table-useradmin-webuser">
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/matchCheck/narcosisFee.js"></script>
</body>
</html>