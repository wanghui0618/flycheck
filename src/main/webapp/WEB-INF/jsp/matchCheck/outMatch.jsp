...
<body>
				...
				<div class="layui-form-item">
					<div class="layui-inline ">
						...
						<div class="layui-input-inline" >
							<select name="outMatch.cityCode" id="city" lay-search="">
					...
					<div class="layui-inline" >
						...
						<div class="layui-input-inline">
							<input type="text" name="outMatch.itemCode"
					...
					<div class="layui-inline" >
						...
						<div class="layui-input-inline">
							<input type="text"
								name="outMatch.itemName" placeholder="请输入" autocomplete="off"
								class="layui-input">
						</div>
					</div>
					<div class="layui-inline">
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/app/js/matchCheck/outMatch.js"></script>
</body>
</html>