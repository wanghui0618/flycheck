    ...
    <div class="layui-col-md12">
    	<div class="layui-col-md12" style="padding-left: 2px;padding-right: 5px;">
            ...
            <div class="layui-inline">
              <label class="layui-form-label" style="width:70px;">耗材名称</label>
        ...
        <div class="layui-card-body">
          <table id="consumablesTable" class="layui-hide" lay-filter="consumablesTable"></table>
        </div>
      </div>
    </div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/itemCost/consumablesCost.js"></script>
