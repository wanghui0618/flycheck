      ...
      <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
          <div class="layui-form-item">
            ...
            <div class="layui-inline">
              <label class="layui-form-label" style="width:100px;">诊疗项目名称</label>
		...
		<div class="layui-col-md12">
        	...
        	<div class="layui-card-body">
          		<table id="diagnosisTable" class="layui-hide" lay-filter="diagnosisTable"></table>
        	</div>
      </div>
    </div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/itemCost/diagnosisCost.js"></script>
