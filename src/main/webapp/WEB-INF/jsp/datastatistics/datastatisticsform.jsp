...
<div class="layui-fluid">
    <div class="layui-card">
      ...
      <div class="layui-form-item">
       ...
       <div class="layui-inline">
           ...
           <!--  <button class="layui-btn layuiadmin-btn-useradmin" data-type=addinfo>添加</button> -->
          </div>
          
        <div class="layui-card-body">
        <table id="medicalTable" class="layui-hide" lay-filter="medicalTable"></table>
         <script type="text/html" id="table-useradmin-webuser">
          <a class="layui-btn layui-btn-xs" lay-event="editinfo">详细信息</a>  
  ...
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/datastatistics/datastatisticsform.js"></script>
  <script>
