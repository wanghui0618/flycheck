...
<body>
		...
		<div class="layui-card" style="height: 360px;">
			...
			<div class="layui-card-body" style="margin-top:-20px;">
				<div class="layui-form" lay-filter="layuiadmin-form-useradmin"
					...
					<input type="hidden" name="consumableRule.itemCode" id="itemCode"
						hide=true>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline" id="sexFlag">
								<select name="consumableRule.sexFlag">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline" id="personType">
								<input type="radio" name="consumableRule.personType" value="1"
									title="是&nbsp;&nbsp;&nbsp;&nbsp;"> <input type="radio"
									name="consumableRule.personType" value="0" title="否&nbsp;&nbsp;&nbsp;" >
							</div>
						</div>
					</div>
					...
					<div class="layui-inline">
						...
						<div class="layui-input-inline" id="indicationFlag">
							<input type="radio" name="consumableRule.indicationFlag"
								value="1" title="是&nbsp;&nbsp;&nbsp;&nbsp;"> <input
								type="radio" name="consumableRule.indicationFlag" value="0"
								title="否&nbsp;&nbsp;&nbsp;">
						</div>
						</div>
							<div class="layui-inline">
							...
							<div class="layui-input-inline" >
								<input type="text" id="indicationComments"
									name="consumableRule.indicationComments" autocomplete="off"
									class="layui-input" >
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-inline" id="contraindicationFlag">
								<input type="radio" name="consumableRule.contraindicationFlag"
									value="1" title="是&nbsp;&nbsp;&nbsp;&nbsp;"> <input type="radio"
									name="consumableRule.contraindicationFlag" value="0" title="否&nbsp;&nbsp;&nbsp;"
									>
							</div>
						</div>
						...
						<div class="layui-block">
							...
							<div class="layui-input-inline" >
								<input type="text" id="contraindicationComments"
									name="consumableRule.contraindicationComments" autocomplete="off"
									class="layui-input" >
							</div>
						</div>
					</div>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="text" id="insuranceMark"
									name="consumableRule.insuranceMark" autocomplete="off"
									class="layui-input">
							</div>
						</div>
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline">
									<input type="text" id="orgLevel" name="consumableRule.orgLevel"
						...
						<div class="layui-form-item">
							<div class="layui-inline">
								...
								<div class="layui-input-inline" id="rescueFlag">
									<input type="radio" name="consumableRule.rescueFlag" value="1"
										title="是&nbsp;&nbsp;&nbsp;&nbsp;"> <input type="radio"
										name="consumableRule.rescueFlag" value="0" title="否&nbsp;&nbsp;&nbsp;" >
								</div>
							</div>
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline" id="diagType">
									<input type="radio" name="consumableRule.diagType" value="1"
										title="门诊" > <input type="radio"
										name="consumableRule.diagType" value="0" title="住院">
								</div>
							</div>
						</div>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/app/js/rulesManager/consumableRuleInfo.js"></script>
</body>
</html>