        ...
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
			        <div class="layui-form-item" >
				            ...
				            <div class="layui-input-block">
				              <input type="text"  id="cityCode"  name="medicalVo.cityName" placeholder="请输入" autocomplete="off" class="layui-input">
			        	  ...
			        	  <div class="layui-inline">
				            ...
				            <div class="layui-input-inline">
								<select name="medicalVo.filterCondition" id="filterCondition">
...
<!-- 				            <button class="layui-btn layuiadmin-btn-useradmin" data-type="add">添加</button>
          ...
          <div class="layui-card-body" style="padding-top:0px">
			     <table id="dataQualityTable" class="layui-hide" lay-filter="dataQualityTable"></table>
			   </div>
        </div>
      </div>
  <script type="text/javascript" src="<%=request.getContextPath() %>/app/js/rulesManager/dataQuality.js"></script>
