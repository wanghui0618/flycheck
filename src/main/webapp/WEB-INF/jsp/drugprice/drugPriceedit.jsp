    ...
    <legend>编辑药品限价信息</legend>
       ...
       <div class="layui-form-item">
          <label class="layui-form-label">药品名称</label>
           <div class="layui-input-inline">
            <input type="text" id="drugName" name="drugPrice.drugName" lay-verify="required"   placeholder="请填写药品名称" autocomplete="off" maxlength="15" class="layui-input">
           </div>
       ...
       <div class="layui-form-item">
           ...
           <div class="layui-input-inline">
          	  <input type="text" id="maxMoney" name="drugPrice.maxMoney"    placeholder="请填写上限金额" autocomplete="off" maxlength="10" class="layui-input">
           </div>
        </div>
         <br>
         <br>
  ...
  layui.config({
    ...
    index: 'lib/index' //主入口模块
	  ...
	  var layer = layui.layer;
	    ...
	    var id=$('#id').val();
		//页面一出来就会执行
	    $.get($WEB_ROOT_PATH+"/dhccApi/drugprice/drugPrice/findById",
				{'drugPrice.id':id},function(data){
					var  field =data.drugPrice;
					$("#cityCode").val(field.cityCode);
					form.render();
		},"json");
  })
  function child(obj){
