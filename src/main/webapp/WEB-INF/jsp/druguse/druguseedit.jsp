      ...
      <br>
        <div class="layui-form-item">
     		 <label class="layui-form-label">适应症：</label>
      			...
      			<textarea id="adaptation"  name="druguse.adaptation" placeholder="" class="layui-textarea"></textarea>
      			</div>
    	</div>
      <br>
        <div class="layui-form-item">
     		 <label class="layui-form-label">用法用量：</label>
     			 <div class="layui-input-block">
     			 <textarea  id="usage" name="druguse.usage" placeholder="" class="layui-textarea"></textarea>
     			 </div>
    	</div>
     <br>
        <div class="layui-form-item">
     		 ...
     		 <div class="layui-input-block">
     		 <textarea  id="pharmacology" name="druguse.pharmacology" placeholder="" class="layui-textarea"></textarea>
     		 </div>
   		 </div>
      <br>
        <div class="layui-form-item">
     		 <label class="layui-form-label">药动学：</label>
      			<div class="layui-input-block">
      			<textarea  id="pharmacokinetics" name="druguse.pharmacokinetics" placeholder="" class="layui-textarea"></textarea>
      			</div>
    	</div>
        <br>
        <div class="layui-form-item">
     		 <label class="layui-form-label">不良反应：</label>
      			<div class="layui-input-block">
      			<textarea  id="untowardEffect" name="druguse.untowardEffect" placeholder="" class="layui-textarea"></textarea>
      			</div>
   		 </div>
    <br>
    <br>
