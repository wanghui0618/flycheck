				...
				<div class="layui-card">
						...
						<div class="layui-form-item pt">
							...
							<div class="layui-inline ">
								...
								<div class="layui-input-block " style="width: 115px;">
									<select name="consumableInfo.cityCode" id="city" lay-filter="city" lay-search=" ">
							...
							<div class="layui-inline">
								...
								<div class="layui-input-block">
									<input  type="text" style="width: 115px;"
										name="consumableInfo.itemCode" placeholder="耗材编码"
							...
							<div class="layui-inline">
								...
								<div class="layui-input-block">
									<input type="text" style="width: 115px;"
										name="consumableInfo.itemlName" placeholder="耗材名称"
										autocomplete="off" class="layui-input">
								</div>
							</div>
							...
							<div class="layui-inline">
								<button id="consumable-relation-search" class="layui-btn layuiadmin-btn-useradmin" lay-submit
					...
					<div class="layui-card-body">
						...
						<script type="text/html" id="table-useradmin-webuser">
							 {{#if (!existsButton('consumable-relation-cxgl')) { }}
...
        			 		 {{# } }}
					...
					<div class="layui-form layui-card-header layuiadmin-card-header-auto" style="padding:3px">
						<div class="layui-form-item pt">
							...
							<div class="layui-inline ">
								<label class="layui-form-label ">版本信息</label>
								<div class="layui-input-block " style="width: 115px;">
									<select name="consumableInfo.cityCode" id="city2" lay-filter="city2" lay-search=" ">
										<option value="" disabled selected style='display: none;'>请选择版本</option>
									</select>
								</div>
							</div>
							...
							<div class="layui-inline">
								<button  id="consumable-relation-search2" class="layui-btn layuiadmin-btn-useradmin" lay-submit
			...
			<div class="layui-col-md12"  style="position:absolute;bottom:0px;">
				<div class="layui-card" >
					<div class="layui-card-body" style="height:31px;text-align:center;">
						<button id='consumable-relation-gl' class="layui-btn layuiadmin-btn-useradmin layui-btn-xs" data-type="relation"  
							lay-filter="LAY-user-front-search-relation">
							关&nbsp;&nbsp;&nbsp;联<i class="layui-icon layui-icon-lianjie layuiadmin-button-btn"></i>
						</button>
						<button id="consumable-relation-jcgl" class="layui-btn layuiadmin-btn-useradmin layui-btn-xs" data-type="breakrelation"
							lay-filter="LAY-user-front-search-breakrelation">
							解除关联<i class="layui-icon layui-icon-lianjie layuiadmin-button-btn"></i>
						</button>
						<button id="consumable-relation-xsqbgl" class="layui-btn layuiadmin-btn-useradmin layui-btn-xs" data-type="showrelation"
							lay-filter="LAY-user-front-search-breakrelation">
	 ...
	 <script type="text/javascript"
		src="<%=request.getContextPath()%>/app/js/consumable_relation/consumableRelation.js"></script> 
	<script>
