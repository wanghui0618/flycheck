...
<body style="overflow:hidden;">
				...
				<div class="layui-form-item">
					<!-- div class="layui-inline pt">
						...
						<div class="layui-input-block " style="width: 160px;">
							<select name="infoForbid.cityCode" id="city" lay-search="">
								<option value="" disabled selected style='display: none;'>请选择城市</option>
							</select>
						</div>
					</div> -->
					<!-- <div class="layui-inline pt">
						<label class="layui-form-label" style="width:90px">医疗机构名</label>
						<div class="layui-input-block">
							<input type="text" style="width: 160px;"
								name="infoForbid.orgName" placeholder="请输入医院机构名称"
					...
					<div class="layui-inline">
				            ...
				            <div class="layui-input-inline">
				                 <input id="getOrgName"/>
                                 <input type="text" id="orgName" name="infoForbid.orgName" style="display: none;" />
				            </div>
				          </div>

					<div class="layui-inline ">
						<button id='infoforbid-search' class="layui-btn layuiadmin-btn-useradmin" lay-submit
							lay-filter="LAY-user-front-search">
							<i class="layui-icon layui-icon-search layuiadmin-button-btn"></i>查询
						</button>
					</div>
					<div class="layui-inline">
						<button id='infoforbid-add' data-type="add"
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/app/js/infoforbid/infoforbid.js"></script>
