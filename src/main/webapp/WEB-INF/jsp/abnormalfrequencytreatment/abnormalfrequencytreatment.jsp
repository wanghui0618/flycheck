		...
		<div class="layui-form layui-card-header layuiadmin-card-header-auto">
			<!-- <div class="layui-form-item"> -->
						<div class="layui-inline">
							<label class="layui-form-label" style="width: 130px;">门诊信息转换 </label> 
							   <div class="layui-input-inline">
								<button onclick="location.href='abnormalfrequencytreatmentzy'" class="layui-btn layuiadmin-btn-useradmin"  stylename="allUpdate">
								<i class="layui-icon layui-icon-refresh layuiadmin-button-btn"></i>住院信息
								</button>							
							</div> 
						</div>
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<!-- <input class="layui-input" name="route" type="text"
									placeholder="市属职工"> -->
							<select  name="route" id="route" lay-verify="required"  lay-filter="xmFilter" >
                                 <option value=""></option> 
                            </select>
							</div> 
						</div>
						...
						<div class="layui-inline cxtjtop">
							<label class="layui-form-label" style="width: 100px; padding-left:40px ">门诊类型</label>
							<div class="layui-input-inline">
						...
						<div class="layui-inline cxtjtop">
							<label class="layui-form-label" style="width: 100px; padding-left:35px ">就诊次数</label>
						...
						<div class="layui-inline">
							...
							<!-- <button onclick="location.href='abnormalfrequencytreatmentzy'"  class="btn">住院</button> -->
						</div>
...
<script type="text/javascript" src="<%=request.getContextPath() %>/app/js/abnormalfrequencytreatment/abnormalfrequencytreatment.js"></script>
