...
<body>
			...
			<div class="layui-form layui-card-header layuiadmin-card-header-auto">
				<div class="layui-form-item">
					<div class="layui-inline layui-col-md4">
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<input type="text" name="inhosDiag" placeholder="请输入诊断名称"
					...
					<%-- <a type="button" class="layui-btn"
						href="<%=request.getContextPath()%>/dhccApi/joney/joney/exportExcel"><i
						class="layui-icon  layui-icon-download-circle"></i>导出</a> --%>
				</div>
			</div>

			<div class="layui-card-body layui-inline layui-col-md4">
				<table id="admissionDiseaseName" class="layui-hide" lay-filter="admissionDiseaseName">
				</table>
			</div>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath()%>/app/js/diseaseAndDiagnosticStatistics/diseaseAndDiagnosticStatistics.js"></script>
</body>
</html>