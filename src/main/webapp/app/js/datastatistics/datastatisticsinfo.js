	    ...
	    table.render({
	    	elem: '#userTable'
	            ...
	            ,cols: [[
	            	   ...
	            	   ,{field:'left', title:'操作', align:'center', toolbar: '#table-useradmin-webuser', width:120,hide:rowOperate(['datastatisticsinfo-viewInfo']),}
	            	   ,{field:'id', title: 'ID',  align:'center',sort: true, hide:true}
	            	   ,{field:'handdingInsName', align:'center', width:220,title:'统筹区' }
			           ,{field:'orgName', align:'center', width:200,title:'医疗机构' }
	            	   ,{field:'name',  align:'center',width:100, title:'姓名'}
			           ...
			           ,{field:'diagType',  align:'center',width:100,title:'就诊类型' }
			           ,{field:'sscno',  align:'center', width:180,title: '社保卡号' }
			           ,{field:'billingNo', align:'center',width:200, title:'收费单据号'}
			           ,{field:'paymentDate', align:'center',width:120, title:'费用发生日期'}
			           ,{field:'reversalMark', align:'center',width:140, title:'冲销标志'}
			           ,{field:'admissionNo',  align:'center',width:200,title:'住院号' }
			           ,{field:'admissionType',  align:'center', width:140,title: '住院类型' }
			           ,{field:'medicalType',  align:'center', width:140,title: '险种类型' }
			           ,{field:'condition',  align:'center', width:180,title: '病情' }
			           ,{field:'departName',  align:'center',width:140,title:'科室' }
			           ...
			           ,{field:'treatmentWay', align:'center',width:120, title:'就诊方式' }
			              ...
			              ,{field:'selfPayAmount', align:'center',width:140, title:'个人自付金额' }
			              ,{field:'selfExpenditureAmount', align:'center',width:140, title:'个人自费金额' }
			              ,{field:'sscAccountCost', align:'center', width:140,title:'个人账户自付' }
			              ,{field:'cashCost',  align:'center',width:140,title:'现金支付金额' }
			              ,{field:'largeCostM', align:'center', width:140,title:'大额应支付' }
			              ,{field:'largeCostR',width:140, align:'center',title:'大额实支付' }
			              ,{field:'civilAffairSubsidy', width:140, align:'center',title:'民政救助' }
			              ...
			              ,{field:'inDiagnosisNo',  width:140,align:'center', title:'入院诊断编码' }
			              ,{field:'inDiagnosisName',   width:140,align:'center',title:'入院诊断名称' }
			              ,{field:'outDiagnosisNo',  width:140,align:'center', title:'出院诊断编码' }
			              ,{field:'outDiagnosisName', width:140, align:'center', title:'出院诊断名称' }
	    ...
	    table.on('tool(userTable)', function(obj){
	      var data = obj.data;
		    ...
		    layer.open({
		          type: 2
		          ,title: '就诊信息详情'
		          ,content: $WEB_ROOT_PATH+'/datastatistics/datastatisticsform'
		          ,maxmin: true
		          ,area: ['1100px', '450px']
		          ,btn: ['确定', '取消']
