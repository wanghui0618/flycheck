layui.config({
    ...
    index: 'lib/index' //主入口模块
	  ...
	  var $ = layui.$
	    ...
	    table.render({
	    	elem: '#drugCostRank'
	            ,url: $WEB_ROOT_PATH+'/dhccApi/medicalAnalysis/medicalAnalysis/drugCostData'
	            ,cellMinWidth: 80
	             ,page:false
	             ,skin:'nob'
	            ,event:true
	            ...
	            ,cols: [[
	            	 ...
	            	 ,{title: '序号',templet: '#xuhao',width:'15%'}
		              ...
		              ,{field:'drugFee', title: '药品费用总数',width:'26%'}
		              ,{field:'drugRatio', title: '药品费用占比',width:'24.555555%',
		            	  templet: function(d){
...
function getValue4(){
	...
	layui.table.reload('drugCostRank',{
		where: field
	});
}