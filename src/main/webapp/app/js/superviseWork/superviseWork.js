				...
				function() {
					...
					table.render({
						elem : '#userTable'
						  ...
						  ,url:$WEB_ROOT_PATH+'/dhccApi/superviseWork/superviseWork/list'
						,
						cellMinWidth : 80
...
,
					...
					$
							.ajax({
								url : $WEB_ROOT_PATH
										+ "/dhccApi/superviseRes/superviseRes/judgeUser",
								type : "get",
										...
										if (obj.event === 'del') {
											//删除
									    	  layer.open({
										          type: 2
										          ,title: '饼图'
										          ,content: $WEB_ROOT_PATH+'/superviseWork/superviseWorkform1'
										          ,maxmin: true
										          ,area: ['900px', '600px']
										         /* ,btn: ['确定', '取消']
										    ...
										    layer.open({
										          type: 2
										          ,title: '柱形图'
										          ,content: $WEB_ROOT_PATH+'/superviseWork/superviseWorkform'
										          ,maxmin: true
										          ,area: ['900px', '600px']
										       /*   ,btn: ['确定', '取消']
										          ,success: function(layero, index){
											    ...
											    layer.open({
											          type: 2
											          ,title: '折线图'
											          ,content: $WEB_ROOT_PATH+'/superviseWork/superviseWorkform2'
											          ,maxmin: true
											          ,area: ['900px', '600px']
											       /*   ,btn: ['确定', '取消']
											          ,success: function(layero, index){
