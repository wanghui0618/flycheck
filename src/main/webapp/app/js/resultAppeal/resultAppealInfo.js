...
function saveDb(){
	var url = $WEB_ROOT_PATH + "/dhccApi/resultAppeal/resultAppeal/saveReason";
	...
	dataAll.field["resultAppeal.itemId"]=$("#itemId").val();
	...
	dataAll.field["medicalId"]=$("#medicalId").val();
