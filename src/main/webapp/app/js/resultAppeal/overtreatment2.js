...
layui.config({
	    ...
	    table.render({
	    	elem: '#userTable'
	            ,url: '/piccbid/app/js/resultAppeal/overtreatment2.json'
	            ,cellMinWidth: 80
	           // ,where: {  }
	            ,height:tableHeight
	            ,cols: [[
	            	   ...
	            	   ,{field:'left',align:'center', title:'操作', toolbar: '#table-useradmin-webuser'}
		              ...
		              ,{field:'hospitalCode', title: '医生编号',align:'center'}
		              ,{field:'hospitalName', title: '医生名称',align:'center'}		             
		              /*,{field:'diagnose', title: '诊断疾病',align:'center'}*/
...
*/
		 table.on('row(userTable)', function(obj){
		      ...
		      layer.open({
		          type: 2
		          ,title: '医生药品使用偏好'
		          ,content: $WEB_ROOT_PATH+'/bigDataAntiFraud/overtreatmentInfo2'
		          ,maxmin: true
		          ,area: ['850px', '420px']
		      });
		 });
