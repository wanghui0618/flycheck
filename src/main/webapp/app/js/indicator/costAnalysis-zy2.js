...
layui.config({
	    ...
	    function test1() {
	    	 table.render({
	            ...
	            ,url:$WEB_ROOT_PATH+'/dhccApi/hosanalysis/hosanalysis/getAllAreaDataZYList'
	            ,limit:5
	            ,height: 280
	           ,page:true
	            ,cols: [[
	            	// 统筹区  住院次数   住院总费用   住院均次费用  占比
		              ...
		              ,{field:'pavgcost',title: '住院次均费用',templet:function(a){
	    ...
	    function test2() {
	    	 table.render({
	            ...
	            ,url:$WEB_ROOT_PATH+'/dhccApi/hosanalysis/hosanalysis/getAllYYDataZYList'
	            ,cellMinWidth: 80
	            ,limit:5
	            ,height: 280
	           ,page:true
	    ...
	    function test3() {
	    	 table.render({
	            ...
	            //,url: $WEB_ROOT_PATH+'/dhccApi/coststatistics/costStatistics/listVo'
	            ,url:$WEB_ROOT_PATH+'/dhccApi/hosanalysis/hosanalysis/getConditionByZYConditionList'
	            ,cellMinWidth: 80
	            ,limit:5
	            ,height: 280
	           ,page:true
