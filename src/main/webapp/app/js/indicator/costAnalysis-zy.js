...
layui.config({
	    ...
	    function test1() {
	    	 table.render({
	            ...
	            ,url:$WEB_ROOT_PATH+'/dhccApi/hosanalysis/hosanalysis/getPCostByArea'
	            ,cellMinWidth: 80
	            ,height: 280
	            ,skin: 'nob' //无边框
	            /*,even: true*/ //开启隔行背景
	            ...
	            ,cols: [[
		              ...
		              ,{field:'area',width: '30%',title: '地区名字'}
		              ,{field:'pcost',width: '30%', title: '次均费用',templet:function(a){
		            	  var codex = a.pnumber;
		            	 
		            	  return changeNumber(codex);
		              }}
		              ,{field:'prate',title: '占总比'}
		            ]]
	    	 ,done:function(){
	    ...
	    function test2() {
	    	 table.render({
	    	     elem: '#doctorTable'
	            //,url: $WEB_ROOT_PATH+'/dhccApi/coststatistics/costStatistics/listVo'
	            ,url:$WEB_ROOT_PATH+'/dhccApi/hosanalysis/hosanalysis/getPCostByHos'
	            ,cellMinWidth: 80
	            ,height: 280
	            ,skin: 'nob' //行边框风格
	            /*,even: true *///开启隔行背景
	            ...
	            ,cols: [[
	            	   {type: 'numbers',width: '10%', title: '序号' }
		              ,{field:'area',width: '30%', title: '医院名字'}
		              ,{field:'pcost',width: '30%', title: '次均费用',templet:function(a){
		            	  var codex = a.pnumber;
