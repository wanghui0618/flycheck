$(function () {
    ...
    $('#fyType').combogrid({
        panelWidth: 370,
        textField: 'name',
        url: $WEB_ROOT_PATH +"/dhccApi/unreasonableAdmission/unreasonableAdmission/fyType",
        fitColumns: true,
        fit:true,
        striped: true,
        editable: true,
    ...
    if (pager) {
        $(pager).pagination({
            ...
            onSelectPage: function (pageNumber, pageSize) { //按分页的设置取数据
                ...
                var url=$WEB_ROOT_PATH +"/dhccApi/unreasonableAdmission/unreasonableAdmission/fyType?keyword="+keyword;
