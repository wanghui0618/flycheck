...
layui.config({
		...
		//加载城市下拉字典
		 ...
		 //初始化left
		 var url=$WEB_ROOT_PATH+'/dhccApi/treatmentrule/treatmentRule/list';
		...
		var active = {
				...
				,breakrelation: function(){//取消关联
					...
					var field={'cityRelation.cityCodeLeft':cityCodeLeft,'cityRelation.cityNameLeft':cityNameLeft,'cityRelation.itemCodeLeft':itemCodeLeft,'cityRelation.cityCodeRight':cityCodeRight,'cityRelation.cityNameRight':cityNameRight,'cityRelation.itemCodeRight':itemCodeRight,'cityRelation.type':2};
			        ...
			        layer.open({
				          type: 2
				          ,title:'诊疗版本对照关系'
				          ,content: $WEB_ROOT_PATH+'/treatmentRelation/showRelation'
				          ,maxmin: true
				          ,area: ['950px', '480px']
...
/*提出来的函数*/
	...
	function loadDate(url,$,form,table,elem,elemn,cityCode,type){
		table.render({
	    	elem: elem
	            ...
	            ,cols: [[
		              ...
		              ,{title:'操作', toolbar: '#table-useradmin-webuser', width:110,align:'center',hide:rowOperate(['treatment-relation-cxgl'])}
		              ...
		              ,{field:'projectType',width:90,align:'center', title: '诊疗分类'}
		              ,{field:'itemStandard',width:90,align:'center', title: '诊疗规格'}
		...
		//执行reload().cityCode=DHCC
		 var field={"treatmentInfo.cityCode":cityCode};
	...
	function selectRelation(direction,$,table){
		...
		var fieldLeft={"cityRelation.cityCodeLeft":data.cityCode,'cityRelation.itemCodeLeft':data.itemCode,'cityRelation.itemNameLeft':data.itemName,'cityRelation.type':2};
		var fieldRight={"cityRelation.cityCodeRight":data.cityCode,'cityRelation.itemCodeRight':data.itemCode,'cityRelation.itemNameRight':data.itemName,'cityRelation.type':2};
