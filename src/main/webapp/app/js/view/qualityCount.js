...
layui.config({
	    ...
	    table.render({
	    	elem: '#qualityTable'
	        ,url: $WEB_ROOT_PATH+'/dhccApi/medical/medical/listTegrity?tableName=T_PICCBID_MEDICAL'
	        ,cellMinWidth: 80
	        ,height:tableHeight
	        ,cols: [[
			...
			,{field:'effectiveNumber',align:'center', title: '有效数据量' }
			,{field:'qualityNumber', align:'center',title: '无效数据量' }
			,{field:'effectiveRate', align:'center',title: '有效率' ,templet:function(d){
