	    ...
	    $.getJSON($WEB_ROOT_PATH+'/dhccApi/dict/dict/findDict?dictRequestVo.tableName=t_piccbid_city_relation',
		   ...
		   table.render({
		    	   elem: '#drugTableShow'
		            ...
		            ,where:{"cityRelation.type":"3","selectType":"all"}
		            ,height: 340
		            ,cols: [[
						 {type: 'numbers', width:80, title: '序号'}
						 ,{title:'操作', width: 155, align:'center', toolbar: '#table-orgadmin-webuser'} 
						,{field:'cityNameLeft',width:150, title: '版本信息' }
						,{field:'itemCodeLeft', width:150,title: '耗材编码' }
						,{field:'itemNameLeft', width:150,title: '耗材名称' }
						,{field:'cityNameRight',width:150, title: '关联版本信息' }
						,{field:'itemCodeRight', width:150,title: '关联耗材编码' }
						,{field:'itemNameRight', width:150,title: '关联耗材名称' }
						]]
		            ,page: true
		          });
