var obj = {"genderLimit.patientGender":$("#patientGender").val()};
layui.config({
    ...
    table.render({
        elem: '#dataTable'
        ,url: $WEB_ROOT_PATH+"/dhccApi/genderLimit/genderLimit/genderLimit"
        ,cellMinWidth: 70
        ...
        ,cols: [[
            ...
            ,{field:'patientGender', width:100,align:'center',title: '性别' }
    ...
    form.on('submit(LAY-user-front-search)', function (data) {
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'admissionDeptName', width:100,align:'center',title: '就诊科室' }
                ,{field:'patientName', width:100,align:'center',title: '患者姓名' }
                ,{field:'patientAge', width:100,align:'center',title: '姓名' }
                ,{field:'admissionDate', width:105,align:'center',title: '入院日期' }
                ,{field:'dischargeDate',width:105, align:'center',title: '出院日期' }
                ,{field:'zyts',width:100, align:'center',title: '住院天数' }
                ,{field:'totalAmount', width:120,align:'center',title: '医疗总费用' }
    ...
    table.on('tool(dataTable)', function(obj){
        if(obj.event === 'searcDetail'){
            ...
            var formIndex = layer.open({
                type: 2,
                area: ['1100px', '500px'],
                content:$WEB_ROOT_PATH + '/genderLimit/detail',
    ...
    form.on('submit(LAY-user-front-export)', function(data){
        ...
        window.open($WEB_ROOT_PATH+"/dhccApi/genderLimit/genderLimit/exportExcel?param="+param);
    });
...
function gather(data) {
    $.ajax({
        url: $WEB_ROOT_PATH + '/dhccApi/genderLimit/genderLimit/gather',
        type: "post",
        dataType: "json",
        data: data,
