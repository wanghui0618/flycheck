...
layui.config({
    ...
    table.render({
        ...
        ,loading:true
        ,url: $WEB_ROOT_PATH+'/dhccApi/abnormalfrequencytreatmentrest/getFrequencyTreatmentzymxbyhisidTable'
        ,loading: true  //翻页加loading
        ,height: tableHeight + 50
        ,cols: [[
            //文本靠左，数字靠右，等长居中
        	
        	//DRUG_SPEC,UNIT_PRICE,NUM,COST,BMI_PAY_AMOUNT
            ...
            ,{field: 'USAGE_DATE', title: '使用日期' ,align:'left',width:170,templet:function(c)
                {
                    return  layui.util.toDateString(c.USAGE_DATE);
                }
            }                      
