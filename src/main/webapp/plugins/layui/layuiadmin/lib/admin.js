...
layui.define('view', function(exports){
  ...
  ,admin = {
    ...
    ,tabsBodyChange: function(index, options){
    	if(options["urlname"]!=""&&options["urlname"]!=null&&options["urlname"]!="undefined"){
    		$("#textHidden").text(" > "+options["urlname"]);
    	}else{
    		$("#textHidden").text(" > "+options["text"]);
    	}
      options = options || {};
  ...
  $body.on('click', '*[lay-href]', function(){
    ...
    ,urlname = othis.attr('lay-urlname')
    ,router = layui.router();
    ...
    topLayui.index.openTabsPage(href, text || othis.text(),urlname);
  });
